  ...
  return (
    <>
      <div className="flex gap-1.5 opacity-0 group-hover/card:opacity-100 transition-opacity">
        <button onClick={() => setIsOpen(true)} title="Edit Customer" className="p-1.5 text-zinc-400 hover:text-blue-400 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-colors shadow-sm cursor-pointer">
          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg>
        </button>
        <button onClick={() => setShowDeleteConfirm(true)} disabled={isDeleting} title="Delete Customer" className="p-1.5 text-zinc-400 hover:text-red-400 bg-white/5 rounded-lg border border-white/10 hover:bg-white/10 transition-colors shadow-sm disabled:opacity-50 cursor-pointer">
